<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeFile="stud_registration.aspx.cs" Inherits="BusMgmt.stud_registration" %>
    ...
    <asp:Label ID="Label10" runat="server" Text="Label" BorderColor="Red" 
              ...
              <div class="box-body">
                                ...
                                <asp:Label ID="Label1" runat="server" Text="Label">Student name</asp:Label>
                                 <asp:TextBox ID="txt_studname"  class="form-control" runat="server" placeholder="enter student name" AutoComplete="off" ></asp:TextBox>
                                </div>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup='valGroup1' runat="server" ErrorMessage="Please enter student name" style="color:Red;" ControlToValidate="txt_studname"></asp:RequiredFieldValidator>
                             <div class="form-group" >
                              
   
        <asp:Label ID="Label2" runat="server" Text="Label">Stud Class</asp:Label>
        <asp:TextBox ID="txt_studclass"  class="form-control" runat="server" placeholder="enter student class" AutoComplete="off"></asp:TextBox>
  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup='valGroup1' ErrorMessage="Please enter student class" style="color:Red;" ControlToValidate="txt_studclass"></asp:RequiredFieldValidator>
    </div>

    
                                <div  class="form-group">
        <asp:Label ID="Label3" runat="server" Text="Label">Stud div</asp:Label>
        <asp:TextBox ID="txt_studdiv"  class="form-control" runat="server" placeholder="enter student div" AutoComplete="off"></asp:TextBox>
  <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup='valGroup1' ErrorMessage="Please enter division" style="color:Red;" ControlToValidate="txt_studdiv"></asp:RequiredFieldValidator>
    </div>
   
  
                                <div class="form-group" >
                              
               <asp:Label ID="Label4" runat="server" Text="Label">Stud Birth date</asp:Label>
                <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <asp:TextBox id="datepicker" class="form-control pull-right" runat="server" placeholder="enter student DOB" AutoComplete="off"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup='valGroup1' ErrorMessage="Please enter birth date" style="color:Red;" ControlToValidate="datepicker"></asp:RequiredFieldValidator>
                </div>
                 </div>
   
      
                                <div  class="form-group">
                                 <asp:Label ID="Label5" runat="server" Text="Label">Stud Gender:</asp:Label>
                                 </br>
    <asp:RadioButton ID="RadioButton1" Text="Male" GroupName="Gender" runat="server"></asp:RadioButton>
    <asp:RadioButton ID="RadioButton2" Text="Female" GroupName="Gender" runat="server"></asp:RadioButton>
<asp:Label ID="Label12" runat="server" Text="Label" Visible="false"></asp:Label>
        ...
        <asp:TextBox ID="txt_studmobileno"   class="form-control" runat="server" placeholder="enter student mobileno" AutoComplete="off" ></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ValidationGroup='valGroup1' ErrorMessage="Please enter mobile no" style="color:Red;" ControlToValidate="txt_studmobileno"></asp:RequiredFieldValidator>
    <asp:RegularExpressionValidator ID="regexmobileValid" runat="server" ValidationGroup='valGroup1' ControlToValidate="txt_studmobileno" ErrorMessage="Enter numbers only till 10 digit" ForeColor="Red" ValidationExpression="[0-9]{10}" ></asp:RegularExpressionValidator>
    </div>
  
 
                                <div class="form-group">
        <asp:Label ID="Label7" runat="server" Text="Label">email id</asp:Label>
        <asp:TextBox ID="txt_studemailid"  class="form-control" runat="server" placeholder="enter student email id" AutoComplete="off" ></asp:TextBox>
<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ValidationGroup='valGroup1' ErrorMessage="Please enter email id" style="color:Red;" ControlToValidate="txt_studemailid"></asp:RequiredFieldValidator>
<asp:RegularExpressionValidator ID="regexEmailValid" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                                            ControlToValidate="txt_studemailid" ErrorMessage="Invalid Email Format" ForeColor="Red"
                                            Display="Dynamic" ValidationGroup="valGroup1"></asp:RegularExpressionValidator>
    </div>

 
                                <div class="form-group">
        <asp:Label ID="Label8" runat="server" Text="Label">Address</asp:Label>
        <asp:TextBox ID="txt_studaddress"   class="form-control" runat="server" placeholder="enter student Address" AutoComplete="off"></asp:TextBox>
   <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ValidationGroup='valGroup1' ErrorMessage="Please enter address" style="color:Red;" ControlToValidate="txt_studaddress"></asp:RequiredFieldValidator>
    </div>

  
                                <div class="form-group">
        <asp:Label ID="Label9" runat="server" Text="Label">area</asp:Label>
        <%--<asp:TextBox ID="txt_studarea"   class="form-control" runat="server" placeholder="enter student area" AutoComplete="off"></asp:TextBox>--%>
<asp:DropDownList ID="DropDownList1" class="form-control" runat="server"></asp:DropDownList>
   <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ValidationGroup='valGroup1' ErrorMessage="Please enter area" style="color:Red;" ControlToValidate="DropDownList1"></asp:RequiredFieldValidator>
        ...
        <asp:Label ID="Label11" runat="server" Text="Label">Stud Roll no</asp:Label>
        <asp:TextBox ID="txt_studrollno" class="form-control" runat="server" placeholder="Enter rollno" AutoComplete="off"></asp:TextBox>

<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup='valGroup1' runat="server" ErrorMessage="Please enter student rollno" style="color:Red;" ControlToValidate="txt_studrollno"></asp:RequiredFieldValidator>
      ...
      <asp:Button ID="Button1" ValidationGroup='valGroup1' class="btn btn-primary" runat="server" Text="submit" onclick="Button1_Click" />
        <asp:Button ID="Button2"  class="btn btn-primary" runat="server" Text="update" onclick="Button2_Click1" />
