<%@ Page Language="C#" AutoEventWireup="true" codefile="barcode.aspx.cs" Inherits="BusMgmt.barcode" %>
...
<header class="main-header">
    ...
    <a href="stud_registration.aspx" class="logo">
      ...
      <span class="logo-lg"><b>School Saftey Enhancement</b></span>
    </a>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
                        ...
                        <h2 class="title">Ganaret QR-Code Form</h2>
    <form id="form1" runat="server">
 
              <div class="box-body">
                                <div class="form-group">
   
                                <asp:Label ID="Label1" runat="server" Text="Label">student id</asp:Label>
                                 <asp:TextBox ID="txt_stud"  class="form-control" runat="server" placeholder="enter Bus no" AutoComplete="off" ></asp:TextBox>
                                </div>
                    
                             <div class="form-group" >
 
               <asp:Button ID="btnQRCode" class="btn btn-primary" runat="server" Text="QR code" 
        ...
        <br />
        <br />
    <button onclick="ClientSidePrint('AccessCard');" class="btn btn-primary btn-outline"> Print</button>
